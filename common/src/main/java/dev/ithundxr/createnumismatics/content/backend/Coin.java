...
public enum Coin implements INamedIconOptions {
    ...
    BEVEL(50, Rarity.COMMON, I_COIN_BEVEL, "\uF012"), // 50 cobre
    SPROCKET(1000, Rarity.COMMON, I_COIN_SPROCKET, "\uF013"), // 1.000 cobre, 20 ferro
    COG(10000, Rarity.UNCOMMON, I_COIN_COG, "\uF014"), // 10.000 cobre, 200 ferro, 10 ouro
    CROWN(100000, Rarity.RARE, I_COIN_CROWN, "\uF015"), // 100.000 cobre, 2.000 ferro, 100 ouro, 10 diamante
    SUN(400000, Rarity.EPIC, I_COIN_SUN, "\uF016") // 400.000 cobre, 8.000 ferro, 400 ouro, 40 diamante, 4 jade
    ;
